...
<ScrollView style={styles.scrollContainer}>
    ...
    <Text style={{paddingTop:0, paddingLeft:15, paddingBottom:7, fontSize:18}}>Pinarello Bike  <Icon name='trash-2' type='feather' color='orange' size='17' style={{paddingLeft: 130, paddingTop:17}}/></Text>
    <Text style={{ paddingLeft:15, paddingBottom:8, color:'grey'}}>Mountain Bike </Text>
    <Text style={{ paddingLeft:10,fontSize:20, fontWeight:'bold'}}> <Text style={{color:'orange'}}>$</Text> 1,200.00   <Icon name='minus' type='feather' color='black' size='17' style={{paddingLeft: 80}}/> <Text>1</Text> <Icon name='plus' type='feather' color='orange' size='17' style={{paddingLeft: 20}}/>  </Text>
    </View>
    </View>
